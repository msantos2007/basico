...
namespace Basico.Web.Controllers
{
    ...
    public class BasicoHubController : ApiControllerWithHub<BasicoHub>
    {
        ...
        public HttpResponseMessage GetQualquerCoisa()
        {
            Console.Write("ddd");
            //int i = 0;
            //return i;
            ...
            //public HttpResponseMessage GetToDoItem(ToDoItem item)
            //{
            //    return null;
            //}
