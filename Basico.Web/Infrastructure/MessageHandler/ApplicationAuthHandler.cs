...
namespace Basico.Web.Infrastructure.MessageHandler
{
    public class ApplicationAuthHandler : DelegatingHandler
        {
            ...
            protected override Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
            {
                ...
                //BasicoHub bhub = new BasicoHub(); 
                //bhub.SendMostar("Passou aqui: " + jsonContent);

                //bhub.Dispose();


                //System.IO.StreamWriter sw = new System.IO.StreamWriter("C:\\temp\\requisicao.txt", true);

                //sw.Write(DateTime.UtcNow + Environment.NewLine);
                //sw.Write(resp.fzupidchannel + Environment.NewLine);
                //sw.Write(resp.fzupresponse + Environment.NewLine);
                //sw.Dispose();
